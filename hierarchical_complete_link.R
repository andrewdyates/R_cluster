...
print("Max dCOR must be at least 0.3")
DCOR <- M[row.max>=0.3, col.max>=0.3]
print(dim(M))
print(dim(DCOR))
...
save(R, DCOR, file="dcor.all.hclust.complete.RData")
...
png("all_dcor_hclust_complete.png", width=w, height=h)
