...
save(R, DCOR, file="dcor.all.hclust.avg.fctx.RData")
...
png("all_dcor_hclust_avg_fctx.png", width=w, height=h)
image(1:w, 1:h, Img, col=heatmap_cols, breaks=heatmap_breaks, axes=FALSE, xlab="", ylab="", useRaster=T)
dev.off()
